...
public class MailGunServiceTest {
	...
	public void testEmailBuilder() {
		...
		MailGunService mgService = new MailGunService(API_URL, API_KEY);
		...
		String strEmail = mgService.buildEmailStr(email);	
		
		String strTest = "from=abc <abc@mail.com>"
				+ "&to=def <def@mail.com>,ghi <ghi@mail.com>"
				+ "&cc=jkl <jkl@mail.com>,mno <mno@mail.com>"
				+ "&bcc=pqr <pqr@mail.com>,stu <stu@mail.com>"
				+ "&subject=Testing+Subject&text=Testing+Text";
		
		System.out.println("Compare Test String: " + strTest);
